...
var Alert = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: `${baseClasses} ${variantClassNames}`, style, role: "alert", "aria-live": "polite", "aria-atomic": "true" }, Icon && /* @__PURE__ */ React.createElement("div", { className: "flex-shrink-0 mt-[2px]" }, /* @__PURE__ */ React.createElement(Icon, null)), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col" }, /* @__PURE__ */ React.createElement("p", { className: textClasses }, title), description && /* @__PURE__ */ React.createElement("p", { className: descClasses }, description)));
};
...
var Card = ({
  ...
  return /* @__PURE__ */ React3.createElement(
    ...
    /* @__PURE__ */ React3.createElement(
      ...
      leftImage && /* @__PURE__ */ React3.createElement("div", { className: "hidden md:block flex-shrink-0 w-[100px] h-[100px] relative rounded-lg overflow-hidden shadow-md" }, /* @__PURE__ */ React3.createElement(
        "img",
        {
          src: leftImage.url,
      ...
      /* @__PURE__ */ React3.createElement("div", { className: "flex-grow min-w-0" }, /* @__PURE__ */ React3.createElement("div", { className: "flex items-center gap-4 mb-3" }, Icon && /* @__PURE__ */ React3.createElement(
        "span",
        {
          className: "text-[var(--entchen-secondary)] flex-shrink-0",
          "aria-hidden": "true"
        },
        /* @__PURE__ */ React3.createElement(Icon, null)
      ), typeof title === "string" ? /* @__PURE__ */ React3.createElement(
        "h3",
        {
        ...
        title
      ) : title), typeof description === "string" ? /* @__PURE__ */ React3.createElement("p", { className: "text-[var(--entchen-text)] break-normal" }, description) : description),
      rightImage && /* @__PURE__ */ React3.createElement("div", { className: "hidden md:block flex-shrink-0 w-[100px] h-[100px] relative rounded-lg overflow-hidden shadow-md" }, /* @__PURE__ */ React3.createElement(
        "img",
        {
          src: rightImage.url,
...
var Dialog = ({
  ...
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, renderTrigger(), rendered && /* @__PURE__ */ React4.createElement(
    "div",
    {
      "aria-modal": "true",
      role: "dialog",
    ...
    /* @__PURE__ */ React4.createElement("div", { className: "absolute inset-0", "aria-hidden": "true", onClick: closeDialog }),
    /* @__PURE__ */ React4.createElement(
      ...
      /* @__PURE__ */ React4.createElement("h2", { id: "dialog-title", className: "text-xl font-semibold mb-2" }, title),
      description && /* @__PURE__ */ React4.createElement("p", { id: "dialog-description", className: "mb-6" }, description),
      /* @__PURE__ */ React4.createElement("div", { className: "flex justify-end gap-3" }, /* @__PURE__ */ React4.createElement(
        Button,
        {
          ...cancelButton,
...
var EntchenProvider = ({ children, theme }) => {
  ...
  return /* @__PURE__ */ React5.createElement(ThemeContext.Provider, { value: theme }, /* @__PURE__ */ React5.createElement("div", { style: {
    ...{
...
var HeroSection = ({
  ...
  return /* @__PURE__ */ React6.createElement("header", { className: "relative w-full h-screen overflow-hidden" }, backgroundImage && /* @__PURE__ */ React6.createElement(
    "img",
    {
  ...
  ), /* @__PURE__ */ React6.createElement("div", { className: "absolute inset-0 bg-[var(--entchen-primary)]/50 backdrop-blur-sm -z-10" }), /* @__PURE__ */ React6.createElement("div", { className: "relative z-10 flex flex-col items-center justify-center h-full px-4 text-center" }, /* @__PURE__ */ React6.createElement("nav", { className: "absolute top-0 left-0 right-0 p-6 max-w-7xl mx-auto flex justify-between items-center" }, /* @__PURE__ */ React6.createElement("a", { href: "/", className: "text-2xl font-bold tracking-widest uppercase cursor-pointer select-none text-[var(--entchen-text)]" }, title), /* @__PURE__ */ React6.createElement("div", { className: "hidden md:flex space-x-6" }, menuItems == null ? void 0 : menuItems.map((item) => /* @__PURE__ */ React6.createElement(
    "a",
    {
      href: item.link,
    ...
    /* @__PURE__ */ React6.createElement("span", { className: "block h-[3px] w-full bg-[var(--entchen-text)] rounded-sm" }),
    /* @__PURE__ */ React6.createElement("span", { className: "block h-[3px] w-full bg-[var(--entchen-text)] rounded-sm" }),
    /* @__PURE__ */ React6.createElement("span", { className: "block h-[3px] w-full bg-[var(--entchen-text)] rounded-sm" })
  )), /* @__PURE__ */ React6.createElement(
    "div",
    ...
    /* @__PURE__ */ React6.createElement("div", { className: "flex justify-end p-4 border-b border-gray700" }, /* @__PURE__ */ React6.createElement(
      "button",
      {
        onClick: () => setMenuOpen(false),
    ...
    /* @__PURE__ */ React6.createElement("nav", { className: "flex flex-col mt-4 space-y-4 px-6 text-lg font-semibold select-none" }, menuItems == null ? void 0 : menuItems.map((item) => /* @__PURE__ */ React6.createElement(
      "a",
      {
        href: item.link,
        key: JSON.stringify(item),
  ...
  ), /* @__PURE__ */ React6.createElement("div", { className: "max-w-6xl w-full flex flex-col items-center md:flex-row md:items-center md:justify-center md:space-x12 mt20 md:mt0" }, image && /* @__PURE__ */ React6.createElement("div", { className: "flex-shrink--0 mb8 md:mb0 md:w1/2 flex justify-center items-center" }, /* @__PURE__ */ React6.createElement(
    "img",
    {
      src: image.url,
    ...
    mainContent.links && /* @__PURE__ */ React6.createElement(
      "div",
      {
        className: "\n                 flex gap-x4 gap-y2 flex-wrap justify-center md:justify-start  \n               "
      },
      mainContent.links.map((item) => /* @__PURE__ */ React6.createElement(
        "a",
        {
          href: item.link,
          key: JSON.stringify(item),
...
var DatePicker = () => {
  return /* @__PURE__ */ React7.createElement("div", { className: "p-20" });
};

// src/Popover/Popover.tsx
import React8, { useState as useState3, useRef, useEffect } from "react";
  ...
  if ("production" !== process.env.NODE_ENV) {
    ...
    try {
      ...
      console.error = function(t3) {
        ...
        E.test(t3) ? (a2 = false, N.delete(s2)) : i2.apply(void 0, e([t3], n2, false));
...
function he(t2) {
  ...
  return "production" === process.env.NODE_ENV ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(t2, " for more information.").concat(n.length > 0 ? " Args: ".concat(n.join(", ")) : "")) : new Error(de.apply(void 0, e([pe[t2]], n, false)).trim());
}
var fe = (function() {
  function e2(e3) {
...
var ke = (function() {
  function e2(e3, n, o2) {
    ...
    var r2 = this;
    this.options = t(t({}, Te), e3), this.gs = n, this.names = new Map(o2), this.server = !!e3.isServer, !this.server && S && Re && (Re = false, _e(this)), ue(this, function() {
      return (function(e4) {
  ...
  return e2.registerId = function(e3) {
    ...
    return void 0 === o2 && (o2 = true), new e2(t(t({}, this.options), n), this.gs, o2 && this.names || void 0);
...
var ze = new ke();
var Me = Fe();
var $e = o.createContext({ shouldForwardProp: void 0, styleSheet: ze, stylis: Me });
var Be = $e.Consumer;
...
function Ye(e2) {
  var t2 = s(e2.stylisPlugins), n = t2[0], r2 = t2[1], c2 = Le().styleSheet, l2 = i(function() {
    var t3 = c2;
  ...
  return o.createElement($e.Provider, { value: d }, o.createElement(Ge.Provider, { value: u2 }, e2.children));
}
var qe = (function() {
  function e2(e3, t2) {
    var n = this;
...
var Je = function(t2) {
  ...
  for (var s2 in t2) {
    var i2 = t2[s2];
    t2.hasOwnProperty(s2) && !Ue(i2) && (Array.isArray(i2) && i2.isCss || re(i2) ? r2.push("".concat(He(s2), ":"), i2, ";") : ce(i2) ? r2.push.apply(r2, e(e(["".concat(s2, " {")], Je(i2), false), ["}"], false)) : r2.push("".concat(He(s2), ": ").concat((n = s2, null == (o2 = i2) || "boolean" == typeof o2 || "" === o2 ? "" : "number" != typeof o2 || 0 === o2 || n in unitlessKeys || n.startsWith("--") ? String(o2).trim() : "".concat(o2, "px")), ";")));
  }
  return r2;
};
...
function it(e2, r2, s2) {
  ...
  function O2(e3, r3) {
    return (function(e4, r4, s3) {
      var i3 = e4.attrs, a3 = e4.componentStyle, c3 = e4.defaultProps, p3 = e4.foldedComponentIds, d2 = e4.styledComponentId, h2 = e4.target, f3 = o.useContext(et), m3 = Le(), y3 = e4.shouldForwardProp || m3.shouldForwardProp;
      "production" !== process.env.NODE_ENV && l(d2);
      var v2 = I(r4, f3, c3) || C, g3 = (function(e5, n, o2) {
        for (var r5, s4 = t(t({}, n), { className: void 0, theme: o2 }), i4 = 0; i4 < e5.length; i4 += 1) {
          var a4 = re(r5 = e5[i4]) ? r5(s4) : r5;
          for (var c4 in a4) s4[c4] = "className" === c4 ? ie(s4[c4], a4[c4]) : "style" === c4 ? t(t({}, s4[c4]), a4[c4]) : a4[c4];
        }
      ...
      var N3 = ie(p3, d2);
      return E3 && (N3 += " " + E3), g3.className && (N3 += " " + g3.className), w3[G(S3) && !A.has(S3) ? "class" : "className"] = N3, s3 && (w3.ref = s3), u(S3, w3);
    })(D2, e3, r3);
  }
  O2.displayName = y2;
...
function lt(t2) {
  for (var n = [], o2 = 1; o2 < arguments.length; o2++) n[o2 - 1] = arguments[o2];
  if (re(t2) || ce(t2)) return ct(Xe(at(_, e([t2], n, true))));
  var r2 = t2;
...
function ut(n, o2, r2) {
  ...
  var s2 = function(t2) {
    ...
    return n(o2, r2, lt.apply(void 0, e([t2], s3, false)));
  };
  return s2.attrs = function(e2) {
    return ut(n, o2, t(t({}, r2), { attrs: Array.prototype.concat(r2.attrs, e2).filter(Boolean) }));
  }, s2.withConfig = function(e2) {
    return ut(n, o2, t(t({}, r2), e2));
  }, s2;
}
var pt = function(e2) {
  return ut(it, e2);
...
var gt = (function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      ...
      return i2 && (s2.nonce = i2), [o.createElement("style", t({}, s2, { key: "sc-0-0" }))];
    }, this.seal = function() {
      e3.sealed = true;
  ...
  return e2.prototype.collectStyles = function(e3) {
    ...
    if (this.sealed) throw he(2);
    this.seal();
    var t2 = __require("stream").Transform, n = e3, o2 = this.instance, r2 = this._emitSheetCSS, s2 = new t2({ transform: function(e4, t3, n2) {
...
var Popover = ({
  ...
  return /* @__PURE__ */ React8.createElement(Container, { ref: popoverRef }, /* @__PURE__ */ React8.createElement(Trigger, { onClick: handleToggle }, trigger), isOpen && /* @__PURE__ */ React8.createElement(Content, null, popoverContent));
};
export {
  Alert,
  Button,
